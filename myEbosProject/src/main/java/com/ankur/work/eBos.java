...
public void testapp	() throws MalformedInputException, InterruptedException, MalformedURLException {
	...
	//WebElement StoreIcon = driver.findElement(By.cssSelector(".locations-icon"));
	/*WebElement StoreIcon = (new WebDriverWait(driver, 10)).until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(".locations-icon")));
	StoreIcon.click();
	
	//WebElement StoreNumber = driver.findElement(By.cssSelector("#store-locations-dropdown>li:nth-child(11)"));
	WebElement StoreNumber = (new WebDriverWait(driver, 10)).until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#store-locations-dropdown>li:nth-child(11)")));
	StoreNumber.click();
	

	//WebElement HamburgerIcon = driver.findElement(By.cssSelector("#menu-icon"));
	WebElement HamburgerIcon = (new WebDriverWait(driver, 10)).until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#menu-icon")));
	HamburgerIcon.click();
	
	WebElement CashMgmtButton = (new WebDriverWait(driver, 10))
			  .until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(".mm-next.mm-fullsubopen")));
	...
	WebElement SkimsTitle = (new WebDriverWait(driver,5)).until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#ebos_page_title")));
